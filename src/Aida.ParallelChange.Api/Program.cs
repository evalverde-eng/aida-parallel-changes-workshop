...
builder.Services.AddSingleton<JsonApiExceptionMapper, ApiRequestValidationJsonApiExceptionMapper>();
builder.Services.AddSingleton<JsonApiExceptionMapper, CustomerContactAlreadyExistsJsonApiExceptionMapper>();
builder.Services.AddSingleton<JsonApiExceptionMapper, CustomerContactNotFoundJsonApiExceptionMapper>();
builder.Services.AddSingleton<JsonApiExceptionMapper, BadHttpRequestJsonApiExceptionMapper>();
builder.Services.AddSingleton<JsonApiExceptionMapper, UnexpectedJsonApiExceptionMapper>();
